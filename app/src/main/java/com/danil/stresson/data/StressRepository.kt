...
val words = listOf(
    ...
    listOf("договоренность", "договорЕнность", R.string.nouns),
    ...
    listOf("отзыв (о книге)", "Отзыв (о книге)", R.string.nouns),
    listOf("отзыв (посла из страны)", "отзЫв (посла из страны)", R.string.nouns),
    ...
    listOf("свекла", "свЕкла", R.string.nouns),
    ...
    listOf("шофер", "шофЕр", R.string.nouns),
    ...
    listOf("щелкать", "щЕлкать", R.string.verbs),
